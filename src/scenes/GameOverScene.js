...
export default class GameOverScene extends Phaser.Scene {
    ...
    create() {
        ...
        // "축하드립니다" 텍스트 추가
        this.add.text(width / 2, height / 2, '이런! 실패하셨습니다!', {
            fontFamily: 'NeoDGM',
        ...
        // "축하드립니다" 텍스트 추가
        this.add.text(width / 2, height / 2 + 30, '괜찮습니다 바로 마스외전으로 가보시겠어요?', {
            fontFamily: 'NeoDGM',
        ...
        // 버튼 추가
        const button = this.add.text(width / 2, height / 2 + 70, '둘러보기', {
            fontFamily: 'NeoDGM',
          ...
          .on('pointerdown', () => {
              window.location.href = 'https://join.marssequel.com/dist/index.html'; // 클릭 시 URL로 이동
          })
          .on('pointerover', () => {
